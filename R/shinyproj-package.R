...
#' @importFrom DT datatable dataTableAjax dataTableOutput dataTableProxy
#' formatStyle JS reloadData renderDataTable selectCells styleInterval
...
#' @importFrom stats as.dist cmdscale cor cutree hclust nobs quantile rgamma setNames
